    ...
    var t = {
            ...
            8175: function (t, e, n) {
                ...
                t.exports = function (t, e, n, g, b, y, m) {
                    ...
                    if (
                        (q && (S = u(q.call(new t()))) !== Object.prototype && S.next && (l(S, P, !0), r || "function" == typeof S[p] || s(S, p, v)),
                        O &&
                            T &&
                            T.name !== h &&
                            ((L = !0),
                        ...
                        if (((x = { values: O ? C : k(h), keys: y ? C : k(f), entries: E }), m)) for (w in x) w in j || i(j, w, x[w]);
                ...
                var r = n(4228),
                    ...
                    l = function () {
                        var t,
                            e = n(6034)("iframe"),
                            r = i.length;
                        for (e.style.display = "none", n(1308).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object</script>"), t.close(), l = t.F; r--; ) delete l[c][i[r]];
                        return l();
                    };
                t.exports =
                    Object.create ||
                    function (t, e) {
                        var n;
                        return null !== t ? ((a[c] = r(t)), (n = new a()), (a[c] = null), (n[s] = t)) : (n = l()), void 0 === e ? n : o(n, e);
                    };
            },
            7967: function (t, e, n) {
                var r = n(4228),
            ...
            8859: function (t, e, n) {
                ...
                (n(6094).inspectSource = function (t) {
                    ...
                    (t.exports = function (t, e, n, a) {
                        ...
                        c && (i(n, "name") || o(n, "name", e)), t[e] !== n && (c && (i(n, s) || o(n, s, t[e] ? "" + t[e] : l.join(String(e)))), t === r ? (t[e] = n) : a ? (t[e] ? (t[e] = n) : o(t, e, n)) : (delete t[e], o(t, e, n)));
            ...
            4556: function (t, e, n) {
                ...
                })("versions", []).push({ version: r.version, mode: n(2750) ? "pure" : "global", copyright: "© 2020 Denis Pushkarev (zloirock.ru)" });
            },
            157: function (t, e, n) {
                var r = n(7087),
                    o = Math.max,
            ...
            5890: function (t, e, n) {
                for (
                    ...
                    var g,
                        ...
                        m = s[b],
                        x = m && m.prototype;
                    if (x && (x[u] || a(x, u, d), x[p] || a(x, p, b), (c[b] = d), y)) for (g in r) x[g] || i(x, g, r[g], !0);
                }
            },
            7999: function (t, e, n) {
                !(function (t) {
                    ...
                    var e,
                        ...
                        w = !x && t.navigator && t.navigator.userAgent && ~t.navigator.userAgent.indexOf("MSIE"),
                        S = x ? t.require : null,
                    ...
                    function C(t, e) {
                        !(function (t, e, n) {
                            var s, f, h;
                            (e = e || O()), x ? (s = S("url").parse(e)) : ((s = document.createElement("a")).href = e);
                            var v,
                                g,
                                b = ((g = { path: !0, query: !0, hash: !0 }), (v = e) && r.test(v) && ((g.protocol = !0), (g.host = !0), o.test(v) && (g.port = !0), i.test(v) && ((g.user = !0), (g.pass = !0))), g);
                            for (f in ((h = e.match(i) || []), k)) b[f] ? (t[f] = s[k[f]] || "") : (t[f] = "");
                            if (
                            ...
                            (t.path = t.path.replace(p, "/")), w && (t.path = t.path.replace(d, "/")), t.paths(t.paths()), (t.query = new T(t.query));
                        })(this, t, !e);
                    }
                    (T.prototype.toString = function () {
                        ...
                        (C.prototype.paths = function (t) {
                            var e,
                                ...
                                r = 0;
                            if (t && t.length && t + "" !== t) {
                                for (this.isAbsolute() && (n = "/"), e = t.length; r < e; r++) t[r] = !r && y.test(t[r]) ? t[r] : L(t[r]);
                                this.path = n + t.join("/");
                            }
                            for (r = 0, e = (t = ("/" === this.path.charAt(0) ? this.path.slice(1) : this.path).split("/")).length; r < e; r++) t[r] = j(t[r]);
                            return t;
                        }),
                        ...
                        (C.prototype.toString = function () {
                            return (
                                ...
                                (this.user && L(this.user) + (this.pass && ":" + L(this.pass)) + "@") +
                                (this.host && this.host) +
                                (this.port && ":" + this.port) +
                                (this.path && this.path) +
    ...
    (n.n = function (t) {
        ...
        (function () {
            ...
            const i = new (e())(),
                s = "appstack-config-",
                a = ".js-settings",
                c = { theme: "default", layout: "fluid", sidebarPosition: "left", sidebarBehavior: "sticky" },
                l = {
                    theme: { default: { bsTheme: "light", sidebarTheme: "dark" }, colored: { bsTheme: "light", sidebarTheme: "colored" }, light: { bsTheme: "light", sidebarTheme: "light" }, dark: { bsTheme: "dark", sidebarTheme: "dark" } },
                    layout: { fluid: { layout: "fluid" }, boxed: { layout: "boxed" } },
                    sidebarPosition: { left: { sidebarPosition: "left" }, right: { sidebarPosition: "right" } },
                    sidebarBehavior: { sticky: { sidebarBehavior: "sticky" }, fixed: { sidebarBehavior: "fixed" }, compact: { sidebarBehavior: "compact" } },
                },
                u = () => {
                    o ||
                        ...
                        .forEach((t) => {
                            t.addEventListener("change", (t) => {
                                g(t.target.name, t.target.value),
                                    ...
                                    "theme" === t.target.name && ((window.cssVariables = r()), window.document.dispatchEvent(new Event("DOMContentLoaded", { bubbles: !0, cancelable: !0 })));
                            });
                        });
                },
                f = () => {
                ...
                h = () => {
                    setTimeout(() => {
                        if (!m("visited")) {
                            document.querySelector(a).classList.toggle("open"), x("visited", !0);
                        }
                    }, 1e3);
                },
                v = () => {
                ...
                g = (t, e) => {
                    for (let [n, r] of Object.entries(l[t][e])) document.documentElement.dataset[n] = r;
                },
                b = () => ({ theme: m("theme"), layout: m("layout"), sidebarPosition: m("sidebarPosition"), sidebarBehavior: m("sidebarBehavior") }),
                y = () => {
